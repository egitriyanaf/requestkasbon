...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{asset('assets/dist/img/Adflogo2.png')}}" alt="AdfLogo" height="100" width="200">
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/" class="brand-link">
      <img src="{{asset('assets/dist/img/Adflogo.png')}}" alt="Adf Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2021 <a href="https://adisdimensionfootwear.co.id">Adis Dimension Footwear</a>.</strong>
    All rights reserved.
    <div class="float-right d-none d-sm-inline-block">
      <b>Version</b> 1.0 | Build By MIS Department
    </div>
  </footer>
